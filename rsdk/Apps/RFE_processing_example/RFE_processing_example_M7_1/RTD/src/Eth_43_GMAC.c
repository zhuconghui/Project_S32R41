...
#define ETH_43_GMAC_SW_MAJOR_VERSION_C               2
...
#if STD_ON == ETH_43_GMAC_DEV_ERROR_DETECT
    uint32 CoreId = Eth_43_GMAC_GetCoreID();
    if ((Std_ReturnType)E_OK == Eth_43_GMAC_Local_CheckEthHLDEntry(CoreId, CtrlIdx, ETH_43_GMAC_SID_PROVIDERXBUFFERINFO))
    {
...
void Eth_43_GMAC_EnteringTxLpi(uint8 CtrlIdx)
{
    ...
    uint32 CoreId = Eth_43_GMAC_GetCoreID();
#if STD_ON == ETH_43_GMAC_DEV_ERROR_DETECT
    if ((Std_ReturnType)E_OK == Eth_43_GMAC_Local_CheckEthHLDEntry(CoreId, CtrlIdx, ETH_43_GMAC_SID_ENTERINGTXLPI))
    {
        if (ETH_MODE_ACTIVE != Eth_43_GMAC_Ipw_GetControllerMode(CtrlIdx))
        {
...
#if STD_ON == ETH_43_GMAC_DEV_ERROR_DETECT
    uint32 CoreId = Eth_43_GMAC_GetCoreID();
    if ((Std_ReturnType)E_OK == Eth_43_GMAC_Local_CheckEthHLDEntry(CoreId, CtrlIdx, ETH_43_GMAC_SID_EXITINGTXLPI))
    {
        if (ETH_MODE_ACTIVE != Eth_43_GMAC_Ipw_GetControllerMode(CtrlIdx))
        {
