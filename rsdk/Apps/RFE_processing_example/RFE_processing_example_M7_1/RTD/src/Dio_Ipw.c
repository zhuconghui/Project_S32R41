...
)
{
    ...
    ChannelLevel = (*(Dio_LevelType*)(SIUL2_DIO_IP_GPDI_ADDR32(u8Siul2Instance, ChannelId))) & SIUL2_DIO_IP_GPDI_MASK_U8;
    return ChannelLevel;
}
...
)
{
    ...
    if ((Dio_LevelType)STD_LOW == ((*(Dio_LevelType*)(SIUL2_DIO_IP_GPDI_ADDR32(u8Siul2Instance, ChannelId))) & SIUL2_DIO_IP_GPDI_MASK_U8))
    {
...
)
{
    ...
    Siul2_Dio_Ip_CoreType u32PGPDOAdrress;

    u8Siul2Instance = Dio_au8PortSiul2Instance[PortId];
    PortOffset      = Dio_au8Port0OffsetInSiul2Instance[u8Siul2Instance];
    u32PGPDOAdrress = SIUL2_DIO_IP_PGPDO_ADDR32(u8Siul2Instance,(Siul2_Dio_Ip_CoreType)((Siul2_Dio_Ip_CoreType)PortId - (Siul2_Dio_Ip_CoreType)PortOffset));
