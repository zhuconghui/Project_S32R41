...
#define POWER_IP_MC_RGM_SW_MAJOR_VERSION_C               2
...
#if (defined(POWER_IP_RESET_DOMAINS_SUPPORTED) && (POWER_IP_RESET_DOMAINS_SUPPORTED == STD_ON))
static void Power_Ip_MC_RGM_ConfigureCore(  const Power_Ip_MC_RGM_CoreConfigType * CoreConfigPtr,
                                            uint8 DomainIndex
                                            );
static void Power_Ip_MC_RGM_CheckConfigureCore( const Power_Ip_MC_RGM_CoreConfigType * CoreConfigPtr,
                                                uint8 DomainIndex
                                                );

static void Power_Ip_MC_RGM_ConfigureCOFB(  const Power_Ip_MC_RGM_CofbConfigType * CofbConfigPtr,
                                            uint8 DomainIndex
                                            );
static void Power_Ip_MC_RGM_CheckConfigureCOFB( const Power_Ip_MC_RGM_CofbConfigType * CofbConfigPtr,
                                                uint8 DomainIndex
                                                );
