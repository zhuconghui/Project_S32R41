...
==================================================================================================*/
/** @brief   Typedef to cast from pointer to integer for 64 bit platforms. */
#if defined(NO_STDINT_H)
#if (CPU_TYPE == CPU_TYPE_64)
typedef uint64 Spi_Ip_Uintptr;
#elif (CPU_TYPE == CPU_TYPE_32)
typedef uint32 Spi_Ip_Uintptr;
#else
    #error "Unsupported CPU_TYPE"
#endif
#else
typedef uintptr_t Spi_Ip_Uintptr;
