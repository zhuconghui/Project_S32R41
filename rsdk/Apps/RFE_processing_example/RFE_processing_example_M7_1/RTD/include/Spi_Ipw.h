...
/* Check if Spi_Ip.h and Spi_Ipw.h are of the same vendor */
#if (SPI_IP_VENDOR_ID != SPI_IPW_VENDOR_ID)
    #error "Spi_Ip.h and Spi_Ipw.h have different vendor ids"
#endif
/* Check if Spi_Ip.h file and Spi_Ipw.h file are of the same Autosar version */
#if ((SPI_IP_AR_RELEASE_MAJOR_VERSION != SPI_IPW_AR_RELEASE_MAJOR_VERSION) || \
     (SPI_IP_AR_RELEASE_MINOR_VERSION != SPI_IPW_AR_RELEASE_MINOR_VERSION) || \
     (SPI_IP_AR_RELEASE_REVISION_VERSION != SPI_IPW_AR_RELEASE_REVISION_VERSION))
#error "AutoSar Version Numbers of Spi_Ip.h and Spi_Ipw.h are different"
#endif
#if ((SPI_IP_SW_MAJOR_VERSION != SPI_IPW_SW_MAJOR_VERSION) || \
     (SPI_IP_SW_MINOR_VERSION != SPI_IPW_SW_MINOR_VERSION) || \
     (SPI_IP_SW_PATCH_VERSION != SPI_IPW_SW_PATCH_VERSION))
#error "Software Version Numbers of Spi_Ip.h and Spi_Ipw.h are different"
#endif
