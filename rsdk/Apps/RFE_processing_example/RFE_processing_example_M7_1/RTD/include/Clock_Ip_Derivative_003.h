...
#define CLOCK_IP_DERIVATIVE_003_SW_MAJOR_VERSION                2
...
#define CLOCK_IP_AURORA_PLL_ATP_PLL_PLL0DIV_DE_DIV_OUTPUT                              4U

#define CLOCK_IP_DIVIDERTRIGGER_CALLBACKS_COUNT                                        1U

#define CLOCK_IP_XOSC_CALLBACKS_COUNT                                                  2U
#define CLOCK_IP_FXOSC_CTRL_OSCON_BYP_STATUS_OSC_STAT                                  1U
...
#define CLOCK_IP_PLLDIG_SW_DIS_PLLPD_RCLKSEL_LOCK                                      1U
#define CLOCK_IP_AURORA_PLL_ATP_PLL_FNPDIV_NDIV_PDIV_FCW                               2U
