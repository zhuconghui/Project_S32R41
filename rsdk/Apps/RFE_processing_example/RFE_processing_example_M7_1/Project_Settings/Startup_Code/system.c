...
/*================================================================================================*/
/*
 * SystemWfiConfig : Implement errata ERR051149 or ERR051357
 */
/*================================================================================================*/
#ifdef ERR_WFI_CONFIG_WORKAROUND
void SystemWfiConfig(void)
{
    ...
    if (!u32EdbStatus)
    {
        ...
        IP_MDM_AP->CTRL_0 |= (MDM_AP_CTRL_0_CM7_0_EDBGREQ_MASK | MDM_AP_CTRL_0_CM7_1_EDBGREQ_MASK);
