...
--------  ---------------------  ----------  ----------  ----------  ----------------  --------------------  --------------------  -----------  ------------  -------------------  ---------------------
       ...
       2  DTCM                   0x20000000  0x2000FFFF          64  Normal            None                  None                  No           Yes           Read/Write           Read/Write
       ...
       4  Realtime SRAM + STACK  0x34000000  0x342FFFFF        3072  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       5  Realtime SRAM NC       0x34300000  0x343FBFFF        1008  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x343FC000  0x343FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
...
/* S32R416LB
       ...
       5  Realtime SRAM NC       0x34200000  0x342FBFFF        1008  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x342FC000  0x342FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
*/
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34000000UL, 0x34200000UL, 0x342FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030BF02BUL, 0x030C0027UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#else
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34000000UL, 0x34300000UL, 0x343FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030BC02BUL, 0x030C0027UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#endif /* S32R416LB */
#else
#if defined(CORE0)
/* Number of entries in the memory tables */
...
--------  ---------------------  ----------  ----------  ----------  ----------------  --------------------  --------------------  -----------  ------------  -------------------  ---------------------
       ...
       2  DTCM                   0x20000000  0x2000FFFF          64  Normal            None                  None                  No           Yes           Read/Write           Read/Write
       3  Application SRAM       0x33C00000  0x33FFFFFF        4096  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       4  Realtime SRAM + STACK  0x34000000  0x3417FFFF        1536  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       5  Realtime SRAM NC       0x34180000  0x341FFFFF         512  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x343FC000  0x343FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
       7  Retention SRAM         0x34400000  0x34403FFF          16  Normal            Write-Back/Allocate   Write-Back/Allocate   Yes          Yes           Read/Write           Read/Write
       8  Peripherals            0x40000000  0x5FFFFFFF      524288  Device            None                  None                  Yes          No            Read/Write           Read/Write
       9  PPB                    0xE0000000  0xE00FFFFF        1024  Strongly Ordered  None                  None                  Yes          No            Read/Write           Read/Write
...
#ifdef S32R416LB
/* S32R416LB
       4  Realtime SRAM + STACK  0x34000000  0x340FFFFF        1024  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       5  Realtime SRAM NC       0x34100000  0x3417FFFF         512  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x342FC000  0x342FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
*/
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34000000UL, 0x34100000UL, 0x342FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030B0027UL, 0x030C0025UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#else
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34000000UL, 0x34180000UL, 0x343FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030BC029UL, 0x030C0025UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#endif /* S32R416LB */
#elif defined(CORE1)
/* Number of entries in the memory tables */
#define CPU_MPU_MEMORY_COUNT (10U)
...
--------  ---------------------  ----------  ----------  ----------  ----------------  --------------------  --------------------  -----------  ------------  -------------------  ---------------------
       ...
       3  Application SRAM       0x33C00000  0x33FFFFFF        4096  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       4  Realtime SRAM + STACK  0x34200000  0x3437FFFF        1536  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       5  Realtime SRAM NC       0x34380000  0x343FBFFF         496  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x343FC000  0x343FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
       7  Retention SRAM         0x34400000  0x34403FFF          16  Normal            Write-Back/Allocate   Write-Back/Allocate   Yes          Yes           Read/Write           Read/Write
       8  Peripherals            0x40000000  0x5FFFFFFF      524288  Device            None                  None                  Yes          No            Read/Write           Read/Write
       9  PPB                    0xE0000000  0xE00FFFFF        1024  Strongly Ordered  None                  None                  Yes          No            Read/Write           Read/Write
...
#ifdef S32R416LB
/* S32R416LB
       4  Realtime SRAM + STACK  0x34180000  0x3427FFFF        1024  Normal            Write-Back/Allocate   Write-Back/Allocate   No           Yes           Read/Write           Read/Write
       5  Realtime SRAM NC       0x34280000  0x342FBFFF         496  Normal            None                  None                  Yes          Yes           Read/Write           Read/Write
       6  Realtime SRAM SHARE    0x342FC000  0x343FFFFF          16  Normal            None                  None                  Yes          No            Read/Write           Read/Write
*/
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34000000UL, 0x34280000UL, 0x342FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030BE72BUL, 0x030C0025UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#else
static const uint32 rbar[] = {0x00000000UL, 0x00000000UL, 0x20000000UL, 0x33C00000UL, 0x34200000UL, 0x34380000UL, 0x343FC000UL, 0x34400000UL, 0x40000000UL, 0xE0000000UL};
static const uint32 rasr[] = {0x1004003FUL, 0x030B0039UL, 0x0308001FUL, 0x030B002BUL, 0x030BC029UL, 0x030C0025UL, 0x130C001BUL, 0x030F001BUL, 0x13050039UL, 0x13040027UL};
#endif /* S32R416LB */
