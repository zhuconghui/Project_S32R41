...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_Leader    ((Spi_SequenceType)0U)
#define SpiConf_SpiSequence_SpiSequence_Folower    ((Spi_SequenceType)1U)
...
*/
#define SPI_TIMEOUT_COUNTER_U32     ((uint32)100000)
