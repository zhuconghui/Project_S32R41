...
static const Clock_Ip_XoscConfigType Clock_Ip_XoscConfigurations_0[CLOCK_IP_CONFIGURED_XOSCS_0_NO] = {
    ...
    #if CLOCK_IP_CONFIGURED_XOSCS_0_NO > 0U
    {
        ...
        15U,                          /* Crystal overdrive protection */
        0U,                     /* Gain value */
        0U,                     /* Monitor type */
...
static const Clock_Ip_SelectorConfigType Clock_Ip_SelectorConfigurations_0[CLOCK_IP_CONFIGURED_SELECTORS_0_NO] = {
    ...
    #if CLOCK_IP_CONFIGURED_SELECTORS_0_NO > 21U
    {
        ...
        COREPLL_PHI8_CLK,                       /* Name of the selected input source */
    },
    #endif
    ...
    #if CLOCK_IP_CONFIGURED_SELECTORS_0_NO > 22U
    {
        ...
        PERIPHPLL_PHI9_CLK,                       /* Name of the selected input source */
    },
    #endif
    ...
    #if CLOCK_IP_CONFIGURED_SELECTORS_0_NO > 23U
    {
        ...
        PERIPHPLL_PHI7_CLK,                       /* Name of the selected input source */
    },
    #endif
...
static const Clock_Ip_CmuConfigType Clock_Ip_CmuConfigurations_0[CLOCK_IP_CONFIGURED_CMUS_0_NO] = {
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 1U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_1_FIRC_CLK */
        (                                           /* IER for CMU_FC_1_FIRC_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 2U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_3_FTM0_EXT_CLK */
        (                                           /* IER for CMU_FC_3_FTM0_EXT_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 3U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_5_STCU_CLK */
        (                                           /* IER for CMU_FC_5_STCU_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 4U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_6_SYS_M7_0_CLK */
        (                                           /* IER for CMU_FC_6_SYS_M7_0_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 5U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_7_SYS_DIV8_CLK */
        (                                           /* IER for CMU_FC_7_SYS_DIV8_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 6U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_8_SYS_M7_1_CLK */
        (                                           /* IER for CMU_FC_8_SYS_M7_1_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 7U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_10_MC_CLK */
        (                                           /* IER for CMU_FC_10_MC_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 8U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_11_CLKOUT0_CLK */
        (                                           /* IER for CMU_FC_11_CLKOUT0_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 9U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_12_FCCU_IPS_CLK */
        (                                           /* IER for CMU_FC_12_FCCU_IPS_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 10U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_13_CAN_PE_CLK */
        (                                           /* IER for CMU_FC_13_CAN_PE_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 12U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_15_GMAC0_TS_CLK */
        (                                           /* IER for CMU_FC_15_GMAC0_TS_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 17U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_23_GMAC1_TX_CLK */
        (                                           /* IER for CMU_FC_23_GMAC1_TX_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 18U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_24_GMAC1_TS_CLK */
        (                                           /* IER for CMU_FC_24_GMAC1_TS_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 19U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_25_GMAC1_RX_CLK */
        (                                           /* IER for CMU_FC_25_GMAC1_RX_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 20U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_26_CTE_CLK */
        (                                           /* IER for CMU_FC_26_CTE_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 21U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_27_A53_CORE_CLK */
        (                                           /* IER for CMU_FC_27_A53_CORE_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 22U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_28_CSI_CFG_CLK */
        (                                           /* IER for CMU_FC_28_CSI_CFG_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 23U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_29_ACCEL_XBAR_DIV4_CLK */
        (                                           /* IER for CMU_FC_29_ACCEL_XBAR_DIV4_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 24U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_30_ACCEL_XBAR_DIV8_CLK */
        (                                           /* IER for CMU_FC_30_ACCEL_XBAR_DIV8_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
    ...
    #if CLOCK_IP_CONFIGURED_CMUS_0_NO > 25U
    {
        ...
        0U,                   /*Enable/disable clock monitor CMU_FC_31_ACCEL_DIV3_CLK */
        (                                           /* IER for CMU_FC_31_ACCEL_DIV3_CLK */
        CMU_FC_IER_FLLIE(0) |
        CMU_FC_IER_FHHIE(0) |
        CMU_FC_IER_FLLAIE(0) |
        CMU_FC_IER_FHHAIE(0)
