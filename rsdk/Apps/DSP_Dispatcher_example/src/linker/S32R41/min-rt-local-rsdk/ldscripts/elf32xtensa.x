/* This linker script generated from xt-genldscripts.tpp for LSP C:/usr/xtensa/Xplorer-9.0.16-workspaces/workspace/rsdkIRAM/RI-2021.6/spt_bbe32_vfpu_gold_r1p3/rsdkIRAM */
/* Linker Script for default link */

RSDK_DSPHD_MSG_BASE_ADDR = 0x34000000;
RSDK_DSPHD_MSG_MEM_SIZE = 0x1000;

SRAM_BASE_ADDR = 0x33C00000;
APP_SRAM_SIZE = RSDK_DSPHD_MSG_BASE_ADDR - SRAM_BASE_ADDR;
MEMORY
{
  srom0_seg :                         	org = 0x00000004, len = 0xFFFFFC
  dram0_0_seg :                       	org = 0x24100000, len = 0x20000
  dram1_0_seg :                       	org = 0x24120000, len = 0x20000
  iram0_0_seg :                       	org = 0x24140000, len = 0x2E0
  iram0_2_seg :                       	org = 0x24140310, len = 0x180
  iram0_4_seg :                       	org = 0x24140800, len = 0x178
  iram0_6_seg :                       	org = 0x2414097C, len = 0x1C
  iram0_8_seg :                       	org = 0x2414099C, len = 0x1C
  iram0_10_seg :                      	org = 0x241409BC, len = 0x1C
  iram0_12_seg :                      	org = 0x241409DC, len = 0x1C
  iram0_14_seg :                      	org = 0x241409FC, len = 0x1C
  iram0_16_seg :                      	org = 0x24140A1C, len = 0x1C
  iram0_18_seg :                      	org = 0x24140A3C, len = 0x1C
  iram0_19_seg :                      	org = 0x24140A58, len = 0x3F5A8
  sram0_seg :                         	org = SRAM_BASE_ADDR, len = APP_SRAM_SIZE
}
...
_memmap_mem_srom_start = 0x4;
_memmap_mem_srom_end   = 0x1000000;
_memmap_mem_dram0_start = 0x24100000;
_memmap_mem_dram0_end   = 0x24120000;
_memmap_mem_dram1_start = 0x24120000;
_memmap_mem_dram1_end   = 0x24140000;
_memmap_mem_iram0_start = 0x24140000;
_memmap_mem_iram0_end   = 0x24180000;
_memmap_mem_sram_start = 0x33c00000;
_memmap_mem_sram_end   = 0x34400000;

/*  Memory segment boundary addresses:  */
_memmap_seg_srom0_start = 0x4;
_memmap_seg_srom0_max   = 0x1000000;
_memmap_seg_dram0_0_start = 0x24100000;
_memmap_seg_dram0_0_max   = 0x24120000;
_memmap_seg_dram1_0_start = 0x24120000;
_memmap_seg_dram1_0_max   = 0x24140000;
_memmap_seg_iram0_0_start = 0x24140000;
_memmap_seg_iram0_0_max   = 0x241402e0;
_memmap_seg_iram0_2_start = 0x24140310;
_memmap_seg_iram0_2_max   = 0x24140490;
_memmap_seg_iram0_4_start = 0x24140800;
_memmap_seg_iram0_4_max   = 0x24140978;
_memmap_seg_iram0_6_start = 0x2414097c;
_memmap_seg_iram0_6_max   = 0x24140998;
_memmap_seg_iram0_8_start = 0x2414099c;
_memmap_seg_iram0_8_max   = 0x241409b8;
_memmap_seg_iram0_10_start = 0x241409bc;
_memmap_seg_iram0_10_max   = 0x241409d8;
_memmap_seg_iram0_12_start = 0x241409dc;
_memmap_seg_iram0_12_max   = 0x241409f8;
_memmap_seg_iram0_14_start = 0x241409fc;
_memmap_seg_iram0_14_max   = 0x24140a18;
_memmap_seg_iram0_16_start = 0x24140a1c;
_memmap_seg_iram0_16_max   = 0x24140a38;
_memmap_seg_iram0_18_start = 0x24140a3c;
_memmap_seg_iram0_18_max   = 0x24140a58;
_memmap_seg_iram0_19_start = 0x24140a58;
_memmap_seg_iram0_19_max   = 0x24180000;
_memmap_seg_sram0_start = 0x33c00000;
_memmap_seg_sram0_max   = 0x34400000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x24140000);
PROVIDE(_memmap_vecbase_reset = 0x24140800);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00000011;
_memmap_cacheattr_wt_base = 0x00000033;
_memmap_cacheattr_bp_base = 0x00000044;
_memmap_cacheattr_unused_mask = 0xFFFFFF00;
_memmap_cacheattr_wb_trapnull = 0x44444411;
_memmap_cacheattr_wba_trapnull = 0x44444411;
_memmap_cacheattr_wbna_trapnull = 0x44444422;
_memmap_cacheattr_wt_trapnull = 0x44444433;
_memmap_cacheattr_bp_trapnull = 0x44444444;
_memmap_cacheattr_wb_strict = 0x00000011;
_memmap_cacheattr_wt_strict = 0x00000033;
_memmap_cacheattr_bp_strict = 0x00000044;
_memmap_cacheattr_wb_allvalid = 0x44444411;
_memmap_cacheattr_wt_allvalid = 0x44444433;
...
SECTIONS
{
  ...
  PROVIDE(__stack = 0x24120000);
  _heap_sentry = 0x24120000;
