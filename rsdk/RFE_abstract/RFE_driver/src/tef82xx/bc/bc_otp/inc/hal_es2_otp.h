...
#ifndef HAL_ES2_OTP_H
#define HAL_ES2_OTP_H
...
//global array to store OTP default values
#ifdef BUILD_FOR_VAL
extern uint32_t gDefaultOTPValues[65];
#endif

// default is master/standalone Barracuda
extern uint8_t gTargetDevice;
extern const OTP_TableDescrip_t OtpTrimTxBiasSt3[OTP_TRIM_TX_BIAS_ST3_COUNT];
extern const OTP_TableDescrip_t OtpTrimTxBiasSt12[OTP_TRIM_TX_BIAS_ST12_COUNT];

extern const OTP_TableDescrip_t OtpTrimTx1Thresh[OTP_TRIM_TX1_THRESH_COUNT];
extern const OTP_TableDescrip_t OtpTrimTx2Thresh[OTP_TRIM_TX2_THRESH_COUNT];
extern const OTP_TableDescrip_t OtpTrimTx3Thresh[OTP_TRIM_TX3_THRESH_COUNT];

extern const OTP_TableDescrip_t OtpTrimRx1Thresh[OTP_TRIM_RX1_THRESH_COUNT];
extern const OTP_TableDescrip_t OtpTrimLoiThresh[OTP_TRIM_LOI_THRESH_COUNT];

extern const OTP_TableDescrip_t OtpTrimSubbandCorrection1g[OTP_TRIM_SUBBAND_CORRECTION_1G_COUNT];
extern const OTP_TableDescrip_t OtpTrimSubbandCorrection2g[OTP_TRIM_SUBBAND_CORRECTION_2G_COUNT];
extern const OTP_TableDescrip_t OtpTrimSubbandCorrection4g[OTP_TRIM_SUBBAND_CORRECTION_4G_COUNT];
