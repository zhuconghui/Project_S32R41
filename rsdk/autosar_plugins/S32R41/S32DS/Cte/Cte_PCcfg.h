...
[!
<code>#define CTE_DEV_ERROR_DETECT                 $(CteGeneral.getChildById("CteDevErrorDetect").getValue()) ? "STD_ON":"STD_OFF"$</code>
!]


/* Pre-processor switch to enable/disable stop execution after error detection for Cte API */
[!
<code>#define CTE_DEV_HALT_ON_ERROR                $(CteGeneral.getChildById("CteErrorHalt").getValue()) ? "STD_ON":"STD_OFF"$</code>
!]
...
[!
<code>#define CTE_SINGLE_MANAGEMENT_THREADS        $(CteGeneral.getChildById("CteSingleThread").getValue()) ? "STD_ON":"STD_OFF"$</code>
!]


/* Pre-processor switch to enable/disable version info report for Cte API                      */
[!
<code>#define CTE_VERSION_INFO_API                 $(CteGeneral.getChildById("CteVersionInfo").getValue()) ? "STD_ON":"STD_OFF"$</code>
!]


/* Pre-processor switch to enable/disable Rx start/stop usage in CTE API                       */
[!
<code>#define CTE_START_STOP_USAGE                 $(CteGeneral.getChildById("CteStartStop").getValue()) ? "STD_ON":"STD_OFF"$</code>
!]
