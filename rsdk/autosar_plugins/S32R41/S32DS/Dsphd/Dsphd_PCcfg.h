...
var DsphdGeneral = (this[0]).getChildById("DsphdGeneralConfiguration");
!]

/* Pre-processor switch to enable/disable error detection during development phase*/
#ifndef DSPHD_DEV_ERROR_DETECT
[!<code>#define DSPHD_DEV_ERROR_DETECT              $(DsphdGeneral.getChildById("DsphdDevErrorDetect").getValue()) ? "STD_ON":"STD_OFF"$</code>!]

#endif

#ifndef DSPHD_DEV_HALT_ON_ERROR
[!<code>#define DSPHD_DEV_HALT_ON_ERROR             $(DsphdGeneral.getChildById("DsphdDevHaltOnError").getValue()) ? "STD_ON":"STD_OFF"$</code>!]

#endif

/* Pre-processor switch to enable/disable version info report */
#ifndef DSPHD_VERSION_INFO_API
[!<code>#define DSPHD_VERSION_INFO_API              $(DsphdGeneral.getChildById("DsphdVersionInfoApi").getValue()) ? "STD_ON":"STD_OFF"$</code>!]
