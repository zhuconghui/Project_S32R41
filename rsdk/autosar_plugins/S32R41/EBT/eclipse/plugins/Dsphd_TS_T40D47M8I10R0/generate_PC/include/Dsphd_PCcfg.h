...
#define DSPHD_DEV_ERROR_DETECT                    [!IF "DsphdGeneral/DsphdDevErrorDetect"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

#ifndef DSPHD_DEV_HALT_ON_ERROR
#define DSPHD_DEV_HALT_ON_ERROR                   [!IF "DsphdGeneral/DsphdDevHaltOnError"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

/* Pre-processor switch to enable/disable version info report */
#ifndef DSPHD_VERSION_INFO_API
#define DSPHD_VERSION_INFO_API                    [!IF "DsphdGeneral/DsphdVersionInfoApi"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif
