...
#define SPT_DEV_ERROR_DETECT                    [!IF "SptGeneral/SptDevErrorDetect"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

/* Pre-processor switch to enable/disable haling on error for development errors for Spt API */
#ifndef SPT_DEV_HALT_ON_ERROR
#define SPT_DEV_HALT_ON_ERROR                   [!IF "SptGeneral/SptHaltOnError"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif
...
#define SPT_SINGLE_THREAD                       [!IF "SptGeneral/SptSingleThread"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

/* Pre-processor switch to enable/disable version info report for Spt API                         */
#ifndef SPT_VERSION_INFO_API
#define SPT_VERSION_INFO_API                    [!IF "SptGeneral/SptVersionInfoApi"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

/* Pre-processor switch to enable/disable DSP support from the SPT driver                         */
#ifndef SPT_DSP_ENABLE
#define SPT_DSP_ENABLE                          [!IF "SptGeneral/SptDspEnable"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif

/* Pre-processor switch to enable/disable polling support from the SPT driver                     */
#ifndef SPT_RUN_POLL
#define SPT_RUN_POLL                            [!IF "SptGeneral/SptRunPoll"!](STD_ON)[!ELSE!](STD_OFF)[!ENDIF!]
#endif
