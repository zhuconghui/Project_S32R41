 ...
 * @version 1.5
 * @date 2022-07-11
 * @brief Peripheral Access Layer for S32R41_CTE
 *
...
#if !defined(S32R41_CTE_H_)  /* Check if memory map has not been already included */
#define S32R41_CTE_H_
...
#define IP_CTE_BASE                              (0x4409C000u)
...
#endif  /* #if !defined(S32R41_CTE_H_) */
