...
struct GICR_tag
{
    GICv3_rdist_if_tag REDIST[4];
};

//define GICR_RD0	(*(volatile struct GICv3_rdist_if *)	0x50900000)
//#define GICR_SGI0	(*(volatile struct GICv3_sgiist_if *)	0x50910000)
//#define GICR_RD1	(*(volatile struct GICv3_rdist_if *)	0x50920000)
//#define GICR_SGI1	(*(volatile struct GICv3_sgiist_if *)	0x50930000)
//#define GICR_RD2	(*(volatile struct GICv3_rdist_if *)	0x50940000)
//#define GICR_SGI2	(*(volatile struct GICv3_sgiist_if *)	0x50950000)
//#define GICR_RD3	(*(volatile struct GICv3_rdist_if *)	0x50960000)
//#define GICR_SGI3	(*(volatile struct GICv3_sgiist_if *)	0x50970000)
