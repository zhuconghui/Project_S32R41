...
#define GMAC_IP_CFG_SW_MAJOR_VERSION             2
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h */
#if (GMAC_IP_CFG_VENDOR_ID != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_VENDOR_ID)
    #error "Gmac_Ip_Cfg.h and Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif
#if ((GMAC_IP_CFG_AR_RELEASE_MAJOR_VERSION    != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (GMAC_IP_CFG_AR_RELEASE_MINOR_VERSION    != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (GMAC_IP_CFG_AR_RELEASE_REVISION_VERSION != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Gmac_Ip_Cfg.h and Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h are different"
#endif
#if ((GMAC_IP_CFG_SW_MAJOR_VERSION != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION) || \
     (GMAC_IP_CFG_SW_MINOR_VERSION != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION) || \
     (GMAC_IP_CFG_SW_PATCH_VERSION != GMAC_IP_SA_BOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Gmac_Ip_Cfg.h and Gmac_Ip_Sa_BOARD_InitPeripherals_PBcfg.h are different"
#endif
...
#define GMAC_CONFIG_EXT \
    GMAC_CONFIG_SA_BOARD_INITPERIPHERALS_PB \
...
#define  GMAC_HAS_CACHE_MANAGEMENT  (STD_ON)
