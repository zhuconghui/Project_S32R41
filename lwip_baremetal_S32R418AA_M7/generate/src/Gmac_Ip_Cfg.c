...
#endif
#ifdef GMAC_1_RXRING_0_DATA
    /*! @brief Reception data buffers for Rx Ring 0 */
    VAR_ALIGN(uint8 GMAC_1_RxRing_0_DataBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED * GMAC_1_MAX_RXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_RXRING_1_DATA
    /*! @brief Reception data buffers for Rx Ring 1 */
    VAR_ALIGN(uint8 GMAC_1_RxRing_1_DataBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED * GMAC_1_MAX_RXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_TXRING_0_DATA
    /*! @brief Transmission data buffers for Tx Ring 0 */
    VAR_ALIGN(uint8 GMAC_1_TxRing_0_DataBuffer[GMAC_1_MAX_TXBUFF_SUPPORTED * GMAC_1_MAX_TXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_TXRING_1_DATA
    /*! @brief Transmission data buffers for Tx Ring 1 */
    VAR_ALIGN(uint8 GMAC_1_TxRing_1_DataBuffer[GMAC_1_MAX_TXBUFF_SUPPORTED * GMAC_1_MAX_TXBUFFLEN_SUPPORTED], FEATURE_GMAC_BUFF_ALIGNMENT_BYTES)
#endif
...
#endif
#ifdef GMAC_1_RXRING_0_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 0 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_1_RxRing_0_DescBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_RXRING_1_DESCR
    /*! @brief Reception buffer descriptors for Rx Ring 1 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_1_RxRing_1_DescBuffer[GMAC_1_MAX_RXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_TXRING_0_DESCR
    /*! @brief Transmission buffer descriptors for Tx Ring 0 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_1_TxRing_0_DescBuffer[GMAC_1_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
#ifdef GMAC_1_TXRING_1_DESCR
    /*! @brief Transmission buffer descriptors for Tx Ring 1 */
    VAR_ALIGN(Gmac_Ip_BufferDescriptorType GMAC_1_TxRing_1_DescBuffer[GMAC_1_MAX_TXBUFF_SUPPORTED], FEATURE_GMAC_BUFFDESCR_ALIGNMENT_BYTES)
#endif
