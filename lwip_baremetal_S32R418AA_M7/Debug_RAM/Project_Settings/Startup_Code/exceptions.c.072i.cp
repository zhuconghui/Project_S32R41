...
undefined_handler/9 (undefined_handler) @05fae9a0
  ...
  Called by: 
  Calls: 
SysTick_Handler/8 (SysTick_Handler) @05fae380
  Type: function definition analyzed
  ...
  Called by: 
  Calls: 
PendSV_Handler/7 (PendSV_Handler) @05faee00
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
DebugMon_Handler/6 (DebugMon_Handler) @05faeb60
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
SVC_Handler/5 (SVC_Handler) @05fae8c0
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
UsageFault_Handler/4 (UsageFault_Handler) @05fae540
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
BusFault_Handler/3 (BusFault_Handler) @05fae2a0
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
MemManage_Handler/2 (MemManage_Handler) @05fae000
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
HardFault_Handler/1 (HardFault_Handler) @05fa7b60
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
NMI_Handler/0 (NMI_Handler) @05fa7d20
  Type: function definition analyzed
  Visibility: externally_visible public weak
  References: 
  Referring: 
...
;; Function NMI_Handler (NMI_Handler, funcdef_no=0, decl_uid=5553, cgraph_uid=1, symbol_order=0)
...
;; Function HardFault_Handler (HardFault_Handler, funcdef_no=1, decl_uid=5555, cgraph_uid=2, symbol_order=1)
...
;; Function MemManage_Handler (MemManage_Handler, funcdef_no=2, decl_uid=5557, cgraph_uid=3, symbol_order=2)
...
;; Function BusFault_Handler (BusFault_Handler, funcdef_no=3, decl_uid=5559, cgraph_uid=4, symbol_order=3)
...
;; Function UsageFault_Handler (UsageFault_Handler, funcdef_no=4, decl_uid=5561, cgraph_uid=5, symbol_order=4)
...
;; Function SVC_Handler (SVC_Handler, funcdef_no=5, decl_uid=5591, cgraph_uid=6, symbol_order=5)
...
;; Function DebugMon_Handler (DebugMon_Handler, funcdef_no=6, decl_uid=5563, cgraph_uid=7, symbol_order=6)
...
;; Function PendSV_Handler (PendSV_Handler, funcdef_no=7, decl_uid=5565, cgraph_uid=8, symbol_order=7)
...
;; Function SysTick_Handler (SysTick_Handler, funcdef_no=8, decl_uid=5567, cgraph_uid=9, symbol_order=8)
...
;; Function undefined_handler (undefined_handler, funcdef_no=9, decl_uid=5569, cgraph_uid=10, symbol_order=9) (executed once)
