...
sys_timeouts_init/10 (sys_timeouts_init) @061709a0
  Type: function
...
dns_init/9 (dns_init) @061708c0
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
igmp_init/8 (igmp_init) @061707e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
udp_init/6 (udp_init) @06170620
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
netif_init/5 (netif_init) @06170540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
memp_init/4 (memp_init) @06170460
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
mem_init/3 (mem_init) @06170380
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
stats_init/2 (stats_init) @061702a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Called by: lwip_init/1 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
lwip_init/1 (lwip_init) @0615dee0
