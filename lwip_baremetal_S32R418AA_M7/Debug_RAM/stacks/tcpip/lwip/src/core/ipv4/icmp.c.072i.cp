...
ip4_route/15 (ip4_route) @0618e700
  Type: function
  ...
  Calls: 
ip4_output_if/14 (ip4_output_if) @0618e460
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_copy/13 (pbuf_copy) @0618e380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_remove_header/12 (pbuf_remove_header) @0618e2a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
memcpy/11 (memcpy) @0618e1c0
  ...
  Calls: 
pbuf_free/10 (pbuf_free) @0618e0e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_alloc/9 (pbuf_alloc) @0618e000
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_add_header/8 (pbuf_add_header) @06179d20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
ip4_addr_isbroadcast_u32/7 (ip4_addr_isbroadcast_u32) @061792a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
ip_data/6 (ip_data) @0618d090
  ...
  Availability: not_available
  Varpool flags:
lwip_stats/5 (lwip_stats) @0618d048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
icmp_send_response/4 (icmp_send_response) @06179c40
...
icmp_time_exceeded/3 (icmp_time_exceeded) @061791c0
  Type: function definition analyzed
...
icmp_dest_unreach/2 (icmp_dest_unreach) @06167ee0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: lwip_stats/5 (read)lwip_stats/5 (write)
  Referring: 
  ...
  Called by: 
  Calls: icmp_send_response/4 (1073741824 (estimated locally),1.00 per call) 
icmp_input/1 (icmp_input) @06167e00
  Type: function definition analyzed
  Visibility: externally_visible public
