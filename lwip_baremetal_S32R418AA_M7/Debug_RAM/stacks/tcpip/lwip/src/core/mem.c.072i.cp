...
memset/15 (memset) @060bb000
  ...
  Calls: 
lwip_stats/14 (lwip_stats) @06051c18
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
mem_calloc/13 (mem_calloc) @0605ae00
...
mem_malloc/12 (mem_malloc) @0605ab60
  Type: function definition analyzed
  Visibility: externally_visible public
...
mem_link_valid/9 (mem_link_valid) @0604a460
  Type: function definition analyzed
...
mem_init/8 (mem_init) @0604a000
  ...
  Called by: 
  Calls: 
plug_holes/7 (plug_holes) @060447e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
