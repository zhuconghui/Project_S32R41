...
Jump functions:
  Jump functions of caller  memset/17:
  ...
  Jump functions of caller  mem_free/10:
    callsite  mem_free/10 -> plug_holes/7 : 
       param 0: PASS THROUGH: 0, op pointer_plus_expr 4294967280
         value: 0x0, mask: 0xffffffff
         VR  ~[0, 0]
...
overall_size: 345, max_new_size: 11001
...
memset/17 (memset) @06126540
  ...
  Called by: mem_calloc/13 (574129754 (estimated locally),0.53 per call) 
  Calls: 
lwip_stats/14 (lwip_stats) @060c7d80
  Type: variable
  ...
  Availability: not_available
  Varpool flags:
mem_calloc/13 (mem_calloc) @060d1e00
  ...
  Called by: 
  Calls: memset/17 (574129754 (estimated locally),0.53 per call) mem_malloc/12 (1073741824 (estimated locally),1.00 per call) 
mem_malloc/12 (mem_malloc) @060d1d20
  Type: function definition analyzed
  Visibility: externally_visible public
  ...
  Called by: mem_calloc/13 (1073741824 (estimated locally),1.00 per call) 
  Calls: 
mem_trim/11 (mem_trim) @060cac40
  Type: function definition analyzed
  Visibility: externally_visible public
...
mem_link_valid/9 (mem_link_valid) @060c0620
  Type: function definition analyzed
...
mem_init/8 (mem_init) @060c01c0
  ...
  Called by: 
  Calls: 
plug_holes/7 (plug_holes) @060ba9a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
...
;; Function mem_init (mem_init, funcdef_no=4, decl_uid=6216, cgraph_uid=5, symbol_order=8)
...
;; Function mem_free (mem_free, funcdef_no=6, decl_uid=6226, cgraph_uid=7, symbol_order=10)
...
mem_free (void * rmem)
{
  ...
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  _10 = MEM[(struct mem *)rmem_3(D) + 4294967280B].used;
  if (_10 == 0)
    goto <bb 18>; [50.00%]
  else
    goto <bb 11>; [50.00%]
  ...
  # DEBUG BEGIN_STMT
  MEM[(struct mem *)rmem_3(D) + 4294967280B].used = 0;
  # DEBUG BEGIN_STMT
  lfree.9_16 = lfree;
  ...
  _20 = MEM[(struct mem *)rmem_3(D) + 4294967280B].next;
  _21 = _19 - _20;
  _22 = _17 + _21;
...
;; Function mem_trim (mem_trim, funcdef_no=7, decl_uid=6219, cgraph_uid=8, symbol_order=11)
...
mem_trim (void * rmem, mem_size_t new_size)
{
  ...
  # DEBUG BEGIN_STMT
  _1 = new_size_30(D) + 15;
  newsize_31 = _1 & 4294967280;
  # DEBUG newsize => newsize_31
  # DEBUG BEGIN_STMT
  if (newsize_31 <= 15)
    goto <bb 4>; [50.00%]
  else
  ...
  # newsize_66 = PHI <newsize_31(3), 16(2)>
  # DEBUG newsize => NULL
  if (new_size_30(D) > newsize_66)
    goto <bb 28>; [17.38%]
  else
    goto <bb 5>; [82.62%]
  ...
  # DEBUG BEGIN_STMT
  _38 = mem_34 - ram.18_2;
  _55 = (long unsigned int) _38;
  # DEBUG mem => NULL
  # DEBUG ptr => _55
  # DEBUG BEGIN_STMT
  _4 = MEM[(struct mem *)rmem_33(D) + 4294967280B].next;
  _5 = _4 - _55;
  size_36 = _5 + 4294967280;
  # DEBUG size => size_36
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  if (size_36 < newsize_66)
    goto <bb 29>; [50.00%]
  else
    goto <bb 11>; [50.00%]
  ...
  _62->prev = _55;
  # DEBUG BEGIN_STMT
  MEM[(struct mem *)rmem_33(D) + 4294967280B].next = ptr2_48;
  # DEBUG BEGIN_STMT
  _9 = _62->next;
  if (_9 != 65536)
    goto <bb 18>; [66.00%]
  ...
  _64->prev = _55;
  # DEBUG BEGIN_STMT
  MEM[(struct mem *)rmem_33(D) + 4294967280B].next = ptr2_37;
  # DEBUG BEGIN_STMT
  _16 = _64->next;
  if (_16 != 65536)
    goto <bb 26>; [66.00%]
  ...
  # DEBUG BEGIN_STMT
  _17 = lwip_stats.mem.used;
  _18 = newsize_66 - size_36;
  _19 = _17 + _18;
  lwip_stats.mem.used = _19;

  <bb 28> [local count: 60897]:
  # _20 = PHI <0B(4), rmem_33(D)(20), rmem_33(D)(11), rmem_33(D)(19), rmem_33(D)(27), 0B(3)>
  return _20;
...
;; Function mem_malloc (mem_malloc, funcdef_no=8, decl_uid=6221, cgraph_uid=9, symbol_order=12)
...
mem_malloc (mem_size_t size_in)
{
  ...
  long unsigned int _19;
  unsigned char _20;
  struct mem * ram_end.26_21;
  struct mem * ram_end.28_22;
  long unsigned int mem.30_23;
  long unsigned int _24;
  long unsigned int _25;
  struct mem * ram_end.31_26;
  long unsigned int ram_end.32_27;
  unsigned int _28;
  ...
  # size_82 = PHI <size_48(4), 16(3)>
  # DEBUG size => NULL
  if (size_in_47(D) > size_82)
    goto <bb 33>; [17.38%]
  else
    goto <bb 6>; [82.62%]
  ...
  # DEBUG BEGIN_STMT
  ram.12_76 = ram;
  _69 = lfree.24_2 - ram.12_76;
  _54 = (long unsigned int) _69;
  # DEBUG mem => NULL
  # DEBUG ptr => _54
  goto <bb 31>; [100.00%]
  ...
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  _11 = lwip_stats.mem.used;
  _12 = _11 + size_82;
  _13 = _12 + 16;
  lwip_stats.mem.used = _13;
  # DEBUG BEGIN_STMT
  _14 = lwip_stats.mem.max;
  if (_13 > _14)
    goto <bb 15>; [50.00%]
  else
    goto <bb 18>; [50.00%]
  ...
  # DEBUG mem => NULL
  _17 = _16 - _80;
  lwip_stats.mem.used = _17;
  # DEBUG BEGIN_STMT
  _18 = lwip_stats.mem.max;
  if (_17 > _18)
    goto <bb 17>; [50.00%]
  else
    goto <bb 18>; [50.00%]
  ...
  # cur_34 = PHI <_81(19), lfree.24_2(38)>
  # DEBUG cur => cur_34
  # DEBUG BEGIN_STMT
  _20 = cur_34->used;
  if (_20 != 0)
  ...
  ram_end.26_21 = ram_end;
  if (ram_end.26_21 != cur_34)
    goto <bb 19>; [94.50%]
  else
    goto <bb 22>; [5.50%]

  <bb 22> [local count: 71983]:
  # _33 = PHI <_20(20), _20(21)>
  # cur_64 = PHI <cur_34(20), cur_34(21)>
  # DEBUG BEGIN_STMT
  lfree = cur_64;
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  ram_end.28_22 = ram_end;
  if (ram_end.28_22 != cur_64)
    goto <bb 23>; [70.00%]
  else
    goto <bb 25>; [30.00%]
  ...
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  mem.30_23 = (long unsigned int) _7;
  _24 = mem.30_23 + size_82;
  _25 = _24 + 16;
  ram_end.31_26 = ram_end;
  ram_end.32_27 = (long unsigned int) ram_end.31_26;
  if (_25 > ram_end.32_27)
    goto <bb 36>; [50.00%]
  else
    goto <bb 27>; [50.00%]
  ...
  # DEBUG BEGIN_STMT
  _30 = lwip_stats.mem.err;
  _31 = _30 + 1;
  lwip_stats.mem.err = _31;
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  ...
  # _35 = PHI <0B(2), 0B(5), _72(29), 0B(32), 0B(4)>
  return _35;
...
;; Function mem_calloc (mem_calloc, funcdef_no=9, decl_uid=6224, cgraph_uid=10, symbol_order=13)
...
mem_calloc (mem_size_t count, mem_size_t size)
{
  ...
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  alloc_size_4 = count_2(D) * size_3(D);
  # DEBUG alloc_size => alloc_size_4
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  p_7 = mem_malloc (alloc_size_4);
  # DEBUG p => p_7
  # DEBUG BEGIN_STMT
  if (p_7 != 0B)
    goto <bb 3>; [53.47%]
