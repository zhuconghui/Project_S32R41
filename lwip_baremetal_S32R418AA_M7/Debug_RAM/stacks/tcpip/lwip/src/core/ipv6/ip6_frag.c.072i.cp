...
ip6_frag_free_pbuf_custom_ref.part.0/31 (ip6_frag_free_pbuf_custom_ref.part.0) @06b518c0
...
lwip_htonl/30 (lwip_htonl) @06d8a620
  Type: function
...
pbuf_ref/29 (pbuf_ref) @06d8a540
  ...
  Calls: 
pbuf_alloced_custom/28 (pbuf_alloced_custom) @06d8a460
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_alloc/27 (pbuf_alloc) @06d8a2a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
identification.7291/26 (identification) @06d81f30
  ...
  Varpool flags:
nd6_get_destination_mtu/25 (nd6_get_destination_mtu) @06d8a1c0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
pbuf_cat/23 (pbuf_cat) @06d2f7e0
  ...
  Calls: 
pbuf_remove_header/22 (pbuf_remove_header) @06d2fee0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
memset/20 (memset) @06d2fd20
  ...
  Calls: 
memp_malloc/19 (memp_malloc) @06d2fc40
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
ip_data/18 (ip_data) @06d7ac18
  ...
  Availability: not_available
  Varpool flags:
lwip_htons/17 (lwip_htons) @06d2fa80
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
lwip_stats/16 (lwip_stats) @06d7ab40
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags:
memp_free/15 (memp_free) @06d2f620
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_free/14 (pbuf_free) @06d2f540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_clen/13 (pbuf_clen) @06d2f460
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
icmp6_time_exceeded_with_addrs/12 (icmp6_time_exceeded_with_addrs) @06d2f380
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
pbuf_header_force/11 (pbuf_header_force) @06d2f2a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
...
ip6_frag_free_pbuf_custom/9 (ip6_frag_free_pbuf_custom) @06d1e7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
ip6_frag_free_pbuf_custom_ref/8 (ip6_frag_free_pbuf_custom_ref) @06d1e540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
...
ip6_frag_alloc_pbuf_custom_ref/7 (ip6_frag_alloc_pbuf_custom_ref) @06d1e2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  Referring: 
...
ip6_reass/6 (ip6_reass) @06d1e000
  Type: function definition analyzed
  Visibility: externally_visible public
...
ip6_reass_remove_oldest_datagram/5 (ip6_reass_remove_oldest_datagram) @06cf5700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
...
ip6_reass_free_complete_datagram/4 (ip6_reass_free_complete_datagram) @06cf5460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
...
ip6_reass_tmr/3 (ip6_reass_tmr) @06ced8c0
  Type: function definition analyzed
  Visibility: externally_visible public
...
ip6_reass_pbufcount/2 (ip6_reass_pbufcount) @06cf1168
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags:
reassdatagrams/1 (reassdatagrams) @06cf10d8
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
