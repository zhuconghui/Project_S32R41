...
strcmp/10 (strcmp) @06044460
  ...
  Calls: 
fs_bytes_left/9 (fs_bytes_left) @06044b60
...
file__index_html/6 (file__index_html) @06045000
...
file__404_html/5 (file__404_html) @05ea8b88
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
file__img_sics_gif/4 (file__img_sics_gif) @05ea8ee8
  Type: variable definition analyzed
  Visibility: externally_visible public
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__index_html/3 (data__index_html) @05ea8e10
  Type: variable definition analyzed
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__404_html/2 (data__404_html) @05ea8cf0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
  ...
  Availability: available
  Varpool flags: initialized read-only const-value-known
data__img_sics_gif/1 (data__img_sics_gif) @05ea8bd0
  Type: variable definition analyzed
  Visibility: prevailing_def_ironly
  References: 
