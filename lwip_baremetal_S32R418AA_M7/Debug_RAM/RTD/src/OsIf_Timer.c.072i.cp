...
OsIf_MicrosToTicks/9 (OsIf_MicrosToTicks) @05f17540
  ...
  Called by: 
  Calls: 
OsIf_SetTimerFrequency/8 (OsIf_SetTimerFrequency) @05f172a0
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
OsIf_GetElapsed/7 (OsIf_GetElapsed) @05f17000
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
OsIf_GetCounter/6 (OsIf_GetCounter) @05f11c40
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
  ...
  Called by: 
  Calls: 
OsIf_Init/5 (OsIf_Init) @05f11700
  Type: function definition analyzed
  Visibility: externally_visible public
  References: 
  Referring: 
...
;; Function OsIf_Init (OsIf_Init, funcdef_no=5, decl_uid=5552, cgraph_uid=6, symbol_order=5)
...
;; Function OsIf_GetCounter (OsIf_GetCounter, funcdef_no=6, decl_uid=5554, cgraph_uid=7, symbol_order=6)
...
;; Function OsIf_GetElapsed (OsIf_GetElapsed, funcdef_no=7, decl_uid=5557, cgraph_uid=8, symbol_order=7)
...
;; Function OsIf_SetTimerFrequency (OsIf_SetTimerFrequency, funcdef_no=8, decl_uid=5560, cgraph_uid=9, symbol_order=8)
...
;; Function OsIf_MicrosToTicks (OsIf_MicrosToTicks, funcdef_no=9, decl_uid=5563, cgraph_uid=10, symbol_order=9)
