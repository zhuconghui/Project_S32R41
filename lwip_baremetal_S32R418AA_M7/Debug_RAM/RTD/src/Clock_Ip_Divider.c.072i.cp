...
Jump functions:
  ...
  Jump functions of caller  Clock_Ip_SetPlldigPll0divDeDivOutput/3:
  Jump functions of caller  Clock_Ip_SetCgmXDeDivWithoutPhase/2:
...
Not considering Clock_Ip_SetPlldigPll0divDeDivOutput for cloning; -fipa-cp-clone disabled.
Not considering Clock_Ip_SetCgmXDeDivWithoutPhase for cloning; -fipa-cp-clone disabled.
...
Lattices:
  Node: Clock_Ip_SetPlldigPll0divDeDivOutput/3:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: Clock_Ip_SetCgmXDeDivWithoutPhase/2:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
...
Clock_Ip_ReportClockErrors/11 (Clock_Ip_ReportClockErrors) @06205d20
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/10 (Clock_Ip_TimeoutExpired) @06205c40
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/9 (Clock_Ip_StartTimeout) @06205b60
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_apxCgm/8 (Clock_Ip_apxCgm) @06207798
  Type: variable
...
Clock_Ip_axFeatureExtensions/7 (Clock_Ip_axFeatureExtensions) @06207750
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_apxPll/6 (Clock_Ip_apxPll) @062074c8
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_au8ClockFeatures/5 (Clock_Ip_au8ClockFeatures) @06207480
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axDividerCallbacks/4 (Clock_Ip_axDividerCallbacks) @06207090
...
Clock_Ip_SetPlldigPll0divDeDivOutput/3 (Clock_Ip_SetPlldigPll0divDeDivOutput) @062052a0
  ...
  Called by: 
  Calls: 
Clock_Ip_SetCgmXDeDivWithoutPhase/2 (Clock_Ip_SetCgmXDeDivWithoutPhase) @061fae00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_axFeatureExtensions/7 (read)Clock_Ip_axFeatureExtensions/7 (read)Clock_Ip_apxCgm/8 (read)
  Referring: Clock_Ip_axDividerCallbacks/4 (addr)
  Availability: available
  Function flags: count:1073741824 (estimated locally) body optimize_size
  Called by: 
  Calls: 
Clock_Ip_SetCgmXDeDivStatWithoutPhase/1 (Clock_Ip_SetCgmXDeDivStatWithoutPhase) @061fa000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_au8ClockFeatures/5 (read)Clock_Ip_axFeatureExtensions/7 (read)Clock_Ip_axFeatureExtensions/7 (read)Clock_Ip_apxCgm/8 (read)
...
Clock_Ip_Callback_DividerEmpty/0 (Clock_Ip_Callback_DividerEmpty) @061fad20
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Clock_Ip_SetCgmXDeDivWithoutPhase (const struct Clock_Ip_DividerConfigType * Config)
{
  ...
  # DEBUG BEGIN_STMT
  _5 = Clock_Ip_au8ClockFeatures[_2][5];
  DividerIndex_18 = (uint32) _5;
  # DEBUG DividerIndex => DividerIndex_18
  # DEBUG BEGIN_STMT
  _6 = Clock_Ip_au8ClockFeatures[_2][2];
  _7 = (int) _6;
  DividerMask_19 = Clock_Ip_axFeatureExtensions[_7].DividerValueMask;
  # DEBUG DividerMask => DividerMask_19
  # DEBUG BEGIN_STMT
  DividerShift_20 = Clock_Ip_axFeatureExtensions[_7].DividerValueShift;
  # DEBUG DividerShift => DividerShift_20
  # DEBUG BEGIN_STMT
  _8 = Clock_Ip_apxCgm[Instance_16][SelectorIndex_17];
  RegValue_21 ={v} _8->Divider[DividerIndex_18];
  # DEBUG RegValue => RegValue_21
  # DEBUG BEGIN_STMT
  _9 = Config_14(D)->Value;
  if (_9 != 0)
    goto <bb 4>; [50.00%]
  else
    goto <bb 5>; [50.00%]
  ...
  # DEBUG BEGIN_STMT
  # DEBUG D#1 => ~DividerMask_19
  # DEBUG RegValue => D#1 & RegValue_21
  # DEBUG BEGIN_STMT
  _10 = _9 + 4294967295;
  _11 = _10 << DividerShift_20;
  _26 = _11 ^ RegValue_21;
  _27 = DividerMask_19 & _26;
  RegValue_23 = RegValue_21 ^ _27;
  # DEBUG RegValue => RegValue_23
  # DEBUG BEGIN_STMT
  RegValue_24 = RegValue_23 | 2147483648;
  # DEBUG RegValue => RegValue_24
  goto <bb 6>; [100.00%]

  <bb 5> [local count: 375809639]:
  # DEBUG BEGIN_STMT
  RegValue_22 = RegValue_21 & 2147483647;
  # DEBUG RegValue => RegValue_22

  <bb 6> [local count: 751619278]:
  # RegValue_12 = PHI <RegValue_24(4), RegValue_22(5)>
  # DEBUG RegValue => RegValue_12
  # DEBUG BEGIN_STMT
  _8->Divider[DividerIndex_18] ={v} RegValue_12;
...
Clock_Ip_SetCgmXDeDivStatWithoutPhase (const struct Clock_Ip_DividerConfigType * Config)
{
  ...
  long unsigned int TimeoutTicks.0_14;
  <unnamed type> _15;
  long unsigned int _19;
  ...
  _2 = (int) _1;
  _3 = Clock_Ip_au8ClockFeatures[_2][0];
  Instance_22 = (uint32) _3;
  # DEBUG Instance => Instance_22
  # DEBUG BEGIN_STMT
  _5 = Clock_Ip_au8ClockFeatures[_2][4];
  SelectorIndex_23 = (uint32) _5;
  # DEBUG SelectorIndex => SelectorIndex_23
  # DEBUG BEGIN_STMT
  _6 = Clock_Ip_au8ClockFeatures[_2][5];
  DividerIndex_24 = (uint32) _6;
  # DEBUG DividerIndex => DividerIndex_24
  # DEBUG BEGIN_STMT
  _7 = Clock_Ip_au8ClockFeatures[_2][2];
  _8 = (int) _7;
  DividerMask_25 = Clock_Ip_axFeatureExtensions[_8].DividerValueMask;
  # DEBUG DividerMask => DividerMask_25
  # DEBUG BEGIN_STMT
  DividerShift_26 = Clock_Ip_axFeatureExtensions[_8].DividerValueShift;
  # DEBUG DividerShift => DividerShift_26
  # DEBUG BEGIN_STMT
  _9 = Clock_Ip_apxCgm[Instance_22][SelectorIndex_23];
  RegValue_27 ={v} _9->Divider[DividerIndex_24];
  # DEBUG RegValue => RegValue_27
  # DEBUG BEGIN_STMT
  _10 = Config_20(D)->Value;
  if (_10 != 0)
    goto <bb 4>; [50.00%]
  else
    goto <bb 5>; [50.00%]
  ...
  # DEBUG BEGIN_STMT
  # DEBUG D#2 => ~DividerMask_25
  # DEBUG RegValue => D#2 & RegValue_27
  # DEBUG BEGIN_STMT
  _11 = _10 + 4294967295;
  _12 = _11 << DividerShift_26;
  _19 = _12 ^ RegValue_27;
  _40 = _19 & DividerMask_25;
  RegValue_29 = RegValue_27 ^ _40;
  # DEBUG RegValue => RegValue_29
  # DEBUG BEGIN_STMT
  RegValue_30 = RegValue_29 | 2147483648;
  # DEBUG RegValue => RegValue_30
  goto <bb 6>; [100.00%]

  <bb 5> [local count: 57431766]:
  # DEBUG BEGIN_STMT
  RegValue_28 = RegValue_27 & 2147483647;
  # DEBUG RegValue => RegValue_28

  <bb 6> [local count: 114863532]:
  # RegValue_16 = PHI <RegValue_30(4), RegValue_28(5)>
  # DEBUG RegValue => RegValue_16
  # DEBUG BEGIN_STMT
  _9->Divider[DividerIndex_24] ={v} RegValue_16;
  # DEBUG BEGIN_STMT
  ...
  # DEBUG BEGIN_STMT
  # DEBUG BEGIN_STMT
  _13 ={v} _9->MUX_DIV_UPD_STAT;
  DividerStatus_33 = _13 & 1;
  # DEBUG DividerStatus => DividerStatus_33
  # DEBUG BEGIN_STMT
  TimeoutTicks.0_14 = TimeoutTicks;
  TimeoutOccurred_35 = Clock_Ip_TimeoutExpired (&StartTime, &ElapsedTime, TimeoutTicks.0_14);
  # DEBUG TimeoutOccurred => TimeoutOccurred_35
  # DEBUG BEGIN_STMT
  if (DividerStatus_33 != 0)
    goto <bb 8>; [94.50%]
  else
    goto <bb 9>; [5.50%]
  ...
  # TimeoutOccurred_4 = PHI <TimeoutOccurred_35(7), TimeoutOccurred_35(8)>
  # DEBUG BEGIN_STMT
