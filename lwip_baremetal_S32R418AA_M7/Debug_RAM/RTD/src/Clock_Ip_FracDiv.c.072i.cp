...
Clock_Ip_ReportClockErrors/10 (Clock_Ip_ReportClockErrors) @06f2bee0
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/9 (Clock_Ip_TimeoutExpired) @06f2be00
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/8 (Clock_Ip_StartTimeout) @06f2bd20
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_apxDfs/7 (Clock_Ip_apxDfs) @06f46090
  Type: variable
...
Clock_Ip_au8ClockFeatures/6 (Clock_Ip_au8ClockFeatures) @06f46048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axFracDivCallbacks/5 (Clock_Ip_axFracDivCallbacks) @06f299d8
...
Clock_Ip_CompleteDfsMfiMfn/4 (Clock_Ip_CompleteDfsMfiMfn) @06f2b700
...
Clock_Ip_SetDfsMfiMfn/3 (Clock_Ip_SetDfsMfiMfn) @06f2b460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_ResetDfsMfiMfn/2 (Clock_Ip_ResetDfsMfiMfn) @06f2b000
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmptyComplete/1 (Clock_Ip_CallbackFracDivEmptyComplete) @06f27c40
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmpty/0 (Clock_Ip_CallbackFracDivEmpty) @06f27e00
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_CallbackFracDivEmpty (Clock_Ip_CallbackFracDivEmpty, funcdef_no=0, decl_uid=6368, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CallbackFracDivEmptyComplete (Clock_Ip_CallbackFracDivEmptyComplete, funcdef_no=1, decl_uid=6370, cgraph_uid=2, symbol_order=1)
...
;; Function Clock_Ip_ResetDfsMfiMfn (Clock_Ip_ResetDfsMfiMfn, funcdef_no=2, decl_uid=6372, cgraph_uid=3, symbol_order=2)
...
Clock_Ip_ResetDfsMfiMfn (const struct Clock_Ip_FracDivConfigType * Config)
{
  ...
  DividerIndex_12 = (uint32) _4;
  # DEBUG DividerIndex => DividerIndex_12
  # DEBUG BEGIN_STMT
  _5 = Clock_Ip_apxDfs[Instance_11];
  _6 ={v} _5->PORTRESET;
  _7 = 1 << DividerIndex_12;
  _8 = _6 | _7;
  _5->PORTRESET ={v} _8;
  return;
...
;; Function Clock_Ip_SetDfsMfiMfn (Clock_Ip_SetDfsMfiMfn, funcdef_no=3, decl_uid=6374, cgraph_uid=4, symbol_order=3)
...
Clock_Ip_SetDfsMfiMfn (const struct Clock_Ip_FracDivConfigType * Config)
{
  ...
  # DEBUG BEGIN_STMT
  _4 = Clock_Ip_au8ClockFeatures[_2][5];
  DividerIndex_18 = (uint32) _4;
  # DEBUG DividerIndex => DividerIndex_18
  # DEBUG BEGIN_STMT
  IntegerPart_19 = Config_15(D)->Value[0];
  # DEBUG IntegerPart => IntegerPart_19
  # DEBUG BEGIN_STMT
  FractionalPart_20 = Config_15(D)->Value[1];
  # DEBUG FractionalPart => FractionalPart_20
  # DEBUG BEGIN_STMT
  _5 = Config_15(D)->Enable;
  if (_5 != 0)
    goto <bb 4>; [50.00%]
  else
    goto <bb 5>; [50.00%]
  ...
  # DEBUG BEGIN_STMT
  _9 = Clock_Ip_apxDfs[Instance_17];
  _9->DVPORT[DividerIndex_18] ={v} Value_21;
  # DEBUG BEGIN_STMT
  _10 ={v} _9->PORTRESET;
  _11 = 1 << DividerIndex_18;
  _12 = ~_11;
  _13 = _10 & _12;
  _9->PORTRESET ={v} _13;
...
;; Function Clock_Ip_CompleteDfsMfiMfn (Clock_Ip_CompleteDfsMfiMfn, funcdef_no=4, decl_uid=6376, cgraph_uid=5, symbol_order=4)
...
Clock_Ip_CompleteDfsMfiMfn (Clock_Ip_NameType DfsName)
{
  ...
  DividerIndex_19 = (uint32) _4;
  # DEBUG DividerIndex => DividerIndex_19
  # DEBUG BEGIN_STMT
  _5 = Clock_Ip_apxDfs[Instance_18];
  _6 ={v} _5->PORTRESET;
  _7 = _6 >> DividerIndex_19;
  _8 = _7 & 1;
  if (_8 == 0)
    goto <bb 3>; [33.00%]
  else
  ...
  # DEBUG BEGIN_STMT
  _9 ={v} _5->PORTSR;
  _10 = 1 << DividerIndex_19;
  _11 = _9 & _10;
  DfsPortStatus_21 = _11 & 3;
  # DEBUG DfsPortStatus => DfsPortStatus_21
  # DEBUG BEGIN_STMT
  TimeoutTicks.0_12 = TimeoutTicks;
  TimeoutOccurred_23 = Clock_Ip_TimeoutExpired (&StartTime, &ElapsedTime, TimeoutTicks.0_12);
  # DEBUG TimeoutOccurred => TimeoutOccurred_23
  # DEBUG BEGIN_STMT
  if (DfsPortStatus_21 == 0)
    goto <bb 5>; [94.50%]
  else
    goto <bb 6>; [5.50%]
  ...
  # TimeoutOccurred_3 = PHI <TimeoutOccurred_23(4), TimeoutOccurred_23(5)>
  # DEBUG BEGIN_STMT
