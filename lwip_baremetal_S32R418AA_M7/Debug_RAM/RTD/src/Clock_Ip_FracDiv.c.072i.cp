...
Clock_Ip_ReportClockErrors/10 (Clock_Ip_ReportClockErrors) @062f6000
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/9 (Clock_Ip_TimeoutExpired) @061df9a0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/8 (Clock_Ip_StartTimeout) @061df540
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_apxDfs/7 (Clock_Ip_apxDfs) @062f4090
  Type: variable
...
Clock_Ip_au8ClockFeatures/6 (Clock_Ip_au8ClockFeatures) @062f4048
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axFracDivCallbacks/5 (Clock_Ip_axFracDivCallbacks) @061dc9d8
...
Clock_Ip_CompleteDfsMfiMfn/4 (Clock_Ip_CompleteDfsMfiMfn) @061dfb60
...
Clock_Ip_SetDfsMfiMfn/3 (Clock_Ip_SetDfsMfiMfn) @061df8c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_ResetDfsMfiMfn/2 (Clock_Ip_ResetDfsMfiMfn) @061df460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_au8ClockFeatures/6 (read)Clock_Ip_apxDfs/7 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmptyComplete/1 (Clock_Ip_CallbackFracDivEmptyComplete) @061df1c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackFracDivEmpty/0 (Clock_Ip_CallbackFracDivEmpty) @061dbee0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
;; Function Clock_Ip_CallbackFracDivEmpty (Clock_Ip_CallbackFracDivEmpty, funcdef_no=0, decl_uid=6375, cgraph_uid=1, symbol_order=0)
...
;; Function Clock_Ip_CallbackFracDivEmptyComplete (Clock_Ip_CallbackFracDivEmptyComplete, funcdef_no=1, decl_uid=6377, cgraph_uid=2, symbol_order=1)
...
;; Function Clock_Ip_ResetDfsMfiMfn (Clock_Ip_ResetDfsMfiMfn, funcdef_no=2, decl_uid=6379, cgraph_uid=3, symbol_order=2)
...
;; Function Clock_Ip_SetDfsMfiMfn (Clock_Ip_SetDfsMfiMfn, funcdef_no=3, decl_uid=6381, cgraph_uid=4, symbol_order=3)
...
;; Function Clock_Ip_CompleteDfsMfiMfn (Clock_Ip_CompleteDfsMfiMfn, funcdef_no=4, decl_uid=6383, cgraph_uid=5, symbol_order=4)
