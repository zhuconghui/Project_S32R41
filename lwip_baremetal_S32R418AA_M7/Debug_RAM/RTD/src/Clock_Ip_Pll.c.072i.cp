...
Jump functions:
  ...
  Jump functions of caller  Clock_Ip_EnablePlldigRdivMfi/10:
  Jump functions of caller  Clock_Ip_CompletePlldigRdivMfi/9:
  Jump functions of caller  Clock_Ip_SetPlldigRdivMfi/8:
  Jump functions of caller  Clock_Ip_ResetPlldigRdivMfi/7:
...
Function Clock_Ip_EnablePlldigRdivMfi/10 is not versionable, reason: not a tree_versionable_function.
Function Clock_Ip_CompletePlldigRdivMfi/9 is not versionable, reason: not a tree_versionable_function.
Not considering Clock_Ip_SetPlldigRdivMfi for cloning; -fipa-cp-clone disabled.
Function Clock_Ip_ResetPlldigRdivMfi/7 is not versionable, reason: not a tree_versionable_function.
...
Lattices:
  Node: Clock_Ip_EnablePlldigRdivMfi/10:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: Clock_Ip_CompletePlldigRdivMfi/9:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: Clock_Ip_SetPlldigRdivMfi/8:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
        AGGS BOTTOM
  Node: Clock_Ip_ResetPlldigRdivMfi/7:
    param [0]: BOTTOM
         ctxs: BOTTOM
         Bits unusable (BOTTOM)
         VARYING
...
Clock_Ip_ReportClockErrors/16 (Clock_Ip_ReportClockErrors) @0702e8c0
  Type: function
  ...
  Calls: 
Clock_Ip_TimeoutExpired/15 (Clock_Ip_TimeoutExpired) @0702e7e0
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_StartTimeout/14 (Clock_Ip_StartTimeout) @0702e700
  Type: function
  Visibility: external public
  References: 
  Referring: 
  ...
  Calls: 
Clock_Ip_apxPll/13 (Clock_Ip_apxPll) @07030d38
  Type: variable
...
Clock_Ip_au8ClockFeatures/12 (Clock_Ip_au8ClockFeatures) @07030cf0
  Type: variable
  Body removed by symtab_remove_unreachable_nodes
  Visibility: external public
  References: 
  ...
  Availability: not_available
  Varpool flags: read-only
Clock_Ip_axPllCallbacks/11 (Clock_Ip_axPllCallbacks) @07030900
...
Clock_Ip_EnablePlldigRdivMfi/10 (Clock_Ip_EnablePlldigRdivMfi) @0702e000
...
Clock_Ip_CompletePlldigRdivMfi/9 (Clock_Ip_CompletePlldigRdivMfi) @070237e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Clock_Ip_SetPlldigRdivMfi/8 (Clock_Ip_SetPlldigRdivMfi) @070232a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Called by: 
  Calls: 
Clock_Ip_ResetPlldigRdivMfi/7 (Clock_Ip_ResetPlldigRdivMfi) @070239a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Clock_Ip_EnablePlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize/6 (Clock_Ip_EnablePlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize) @07023700
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  ...
  Calls: 
Clock_Ip_CompletePlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize/5 (Clock_Ip_CompletePlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize) @07023460
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/12 (read)Clock_Ip_apxPll/13 (read)
...
Clock_Ip_SetPlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize/4 (Clock_Ip_SetPlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize) @070231c0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/12 (read)Clock_Ip_apxPll/13 (read)Clock_Ip_apxPll/13 (read)Clock_Ip_apxPll/13 (read)
  ...
  Called by: 
  Calls: 
Clock_Ip_ResetPlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize/3 (Clock_Ip_ResetPlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize) @06f0fa80
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: Clock_Ip_au8ClockFeatures/12 (read)Clock_Ip_apxPll/13 (read)Clock_Ip_apxPll/13 (read)Clock_Ip_apxPll/13 (read)
  ...
  Calls: 
Clock_Ip_CallbackPllEmptyDisable/2 (Clock_Ip_CallbackPllEmptyDisable) @06f0f7e0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackPllEmptyComplete/1 (Clock_Ip_CallbackPllEmptyComplete) @06f0f540
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
  ...
  Called by: 
  Calls: 
Clock_Ip_CallbackPllEmpty/0 (Clock_Ip_CallbackPllEmpty) @06f0f2a0
  Type: function definition analyzed
  Visibility: prevailing_def_ironly
  Address is taken.
  References: 
...
Clock_Ip_SetPlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize (const struct Clock_Ip_PllConfigType * Config)
{
  ...
  # DEBUG BEGIN_STMT
  _5 = Config_40(D)->InputReference;
  switch (_5) <default: <L9> [33.33%], case 1: <L2> [33.33%], case 2: <L3> [33.33%]>

  <bb 5> [local count: 125257353]:
<L2>:
  # DEBUG BEGIN_STMT
  _6 = Clock_Ip_apxPll[Instance_42].PllInstance;
  _6->PLLCLKMUX ={v} 0;
  # DEBUG BEGIN_STMT
  goto <bb 7>; [100.00%]

  <bb 6> [local count: 125257353]:
<L3>:
  # DEBUG BEGIN_STMT
  _7 = Clock_Ip_apxPll[Instance_42].PllInstance;
  _7->PLLCLKMUX ={v} 1;
  # DEBUG BEGIN_STMT

  <bb 7> [local count: 375772058]:
<L9>:
  # DEBUG BEGIN_STMT
  _8 = Clock_Ip_apxPll[Instance_42].PllInstance;
  Value_45 ={v} _8->PLLDV;
  # DEBUG Value => Value_45
  # DEBUG BEGIN_STMT
  Value_46 = Value_45 & 4294938368;
  # DEBUG Value => Value_46
  # DEBUG BEGIN_STMT
  _9 = Config_40(D)->Predivider;
  _10 = (long unsigned int) _9;
  _11 = _10 << 12;
  _12 = _11 & 28672;
  _13 = Config_40(D)->MulFactorDiv;
  ...
  # DEBUG BEGIN_STMT
  Value_50 = Value_49 & 3221192704;
  # DEBUG Value => Value_50
  # DEBUG BEGIN_STMT
  _16 = Config_40(D)->NumeratorFracLoopDiv;
  _56 = _16 & 32767;
  _17 = (long unsigned int) _56;
  Value_51 = _17 | Value_50;
  # DEBUG Value => Value_51
  # DEBUG BEGIN_STMT
  _18 = Config_40(D)->SigmaDelta;
  _19 = (long unsigned int) _18;
  _20 = _19 << 30;
  _21 = _20 & 1073741824;
  Value_52 = _21 | Value_51;
  # DEBUG Value => Value_52
  # DEBUG BEGIN_STMT
  _8->PLLFD ={v} Value_52;
  # DEBUG BEGIN_STMT
  _22 = Config_40(D)->FrequencyModulationBypass;
  _23 = (long unsigned int) _22;
  _24 = _23 << 30;
  _25 = _24 & 1073741824;
  _26 = Config_40(D)->ModulationType;
  _27 = (long unsigned int) _26;
  _28 = _27 << 29;
  _29 = _28 & 536870912;
  _30 = _25 | _29;
  _31 = Config_40(D)->IncrementStep;
  _57 = _31 & 2047;
  _32 = (long unsigned int) _57;
  _33 = _30 | _32;
  _34 = Config_40(D)->ModulationPeriod;
...
<L3>:
  # DEBUG BEGIN_STMT
  _7 = Clock_Ip_apxPll[Instance_20].PllInstance;
  _7->PLLCLKMUX ={v} 1;
  # DEBUG BEGIN_STMT
...
<L9>:
  # DEBUG BEGIN_STMT
  _8 = Clock_Ip_apxPll[Instance_20].PllInstance;
  Value_23 ={v} _8->PLLDV;
  # DEBUG Value => Value_23
  # DEBUG BEGIN_STMT
  Value_24 = Value_23 & 4294938368;
  # DEBUG Value => Value_24
  # DEBUG BEGIN_STMT
  _9 = Config_18(D)->Predivider;
  _10 = (long unsigned int) _9;
  _11 = _10 << 12;
  _12 = _11 & 28672;
  _13 = Config_18(D)->MulFactorDiv;
  _14 = (long unsigned int) _13;
  _15 = _12 | _14;
  Value_25 = _15 | Value_24;
...
{
  Clock_Ip_PllStatusReturnType retval.15;

  <bb 2> [local count: 276913048]:
  retval.15_4 = Clock_Ip_CompletePlldigRdivMfiMfnSdmenSsscgbypSpreadctlStepnoStepsize (PllName_2(D)); [tail call]
  return retval.15_4;
