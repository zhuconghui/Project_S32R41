...
#define SOCK_TARGET_HOST6  "FE80::2EC8:1BFF:FE41:D8F"
#endif
...
static inline void wait_for_ip(void)
{
  ...
  /* Additionally 5s delay added for initialization and non-blocking purposes */
  sys_msleep(5000);
}
...
#define SNDSTR1 "G"
  ...
  /* An ASSERT is returned if not a classic HTTP server is being used */
